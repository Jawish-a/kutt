...
const spec = {
  ...
  SITE_NAME: str({ example: "Ly.sa", default: "Ly.sa" }),
  DEFAULT_DOMAIN: str({ example: "ly.sa", default: "ly.sa" }),
  ...
  MAIL_FROM: str({ default: "", example: "Ly.sa <support@ly.sa>" }),
